/*Função que cruza registro com bolas marcadas: Verifica se os números marcados 
estão de acordo com as bolas já sorteadas e remove os que não estiverem.*/
...
//  let markedNumbers = [3, 5, 7, 8, 9, 11, 15, 22, 25, 28, 31, 33, 34, 35, 41, 53];
